  ...
  const handleImageUpload = async (event) => {
    ...
    try {
      ...
      setAnalysisResult({
        ...
        severity: 'high', // optional: adjust based on model output
      });
    } catch (err) {
        ...
        <div className="glass-card rounded-2xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center p-6 bg-[#C0CFC5] rounded-2xl border border-[#091B07]/20">
              ...
              <p className="text-[#091B07]">
                Take a clear photo of the pest. Make sure the image is well-lit and focused.
              </p>
            </div>
            ...
            <div className="text-center p-6 bg-[#C0CFC5] rounded-2xl border border-[#091B07]/20">
              ...
              <p className="text-[#091B07]">
                Our advanced AI model analyzes the image to identify the pest species.
              </p>
            </div>
          ...
          <div className="mt-8 p-6 bg-[#091B07] rounded-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start">
                ...
                <p className="text-[#C0CFC5] text-sm">Use natural lighting to clearly show the pest’s features</p>
              </div>
              <div className="flex items-start">
                <span className="w-2 h-2 bg-[#C0CFC5] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <p className="text-[#C0CFC5] text-sm">Take a close-up photo of the pest</p>
              </div>
              <div className="flex items-start">
                <span className="w-2 h-2 bg-[#C0CFC5] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <p className="text-[#C0CFC5] text-sm">Capture the pest from multiple angles</p>
              </div>
              <div className="flex items-start">
                <span className="w-2 h-2 bg-[#C0CFC5] rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <p className="text-[#C0CFC5] text-sm">Upload as soon as you spot the pest for fastest identification</p>
              </div>
            </div>
          </div>
        </div>
